 ...
 */
export declare const reduce: <TElement, TResult>(array: TElement[], fn: ReduceFn<TElement, TResult>, init: TResult) => TResult;
/** Alias for `reduce()` */
export declare const aggregate: <TElement, TResult>(array: TElement[], fn: ReduceFn<TElement, TResult>, init: TResult) => TResult;
